  ...
  on_supported_os(test_on).each do |_os, os_facts|
    describe 'variable data type and content validations' do
      ...
      validations = {
        ...
        'Boolean' => {
          name:    ['manage_nis', 'enable_group_policies', 'users_allow_hiera_merge', 'users_deny_hiera_merge',
                    'user_override_hiera_merge', 'group_override_hiera_merge', 'domain_change', 'vas_conf_vasd_workstation_mode',
        ...
        'String[1]' => {
          name:    ['package_version', 'username', 'keytab_owner', 'keytab_group', 'nismaps_ou', 'vas_conf_group_update_mode',
                    'vas_conf_root_update_mode', 'vas_conf_upm_computerou_attr', 'vas_conf_prompt_vas_ad_pw',
                    'vas_conf_libdefaults_tgs_default_enctypes', 'vas_conf_libdefaults_tkt_default_enctypes',
                    'vas_conf_libdefaults_default_etypes', 'vas_conf_libvas_use_server_referrals_version_switch',
                    'vas_config_owner', 'vas_config_group', 'vas_user_override_owner', 'vas_user_override_group',
                    'vas_group_override_owner', 'vas_group_override_group', 'vas_users_allow_owner',
                    'vas_users_allow_group', 'vas_users_deny_owner', 'vas_users_deny_group'],
          valid:   ['string'],
